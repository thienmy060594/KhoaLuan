...
namespace KiemDinhChatLuongDTO
{
    public class MinhChungDTO
    {
        ...
        public MinhChungDTO(int matailieu, string tentailieu, string ngayky, string nguoiky, string sobanhanh, string tomtatnoidung, string duonglink, string ghichu)
        {
        ...
        {
            this.MaTaiLieu =Int32.Parse(row["MaTaiLieu"].ToString());
